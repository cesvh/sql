...
ORDER BY list_price DESC; --321 rows

SELECT TOP 10 product_name, list_price 
FROM production.products 
ORDER BY list_price DESC; --10 rows

SELECT TOP 1 PERCENT product_name, list_price 
FROM production.products 
ORDER BY list_price DESC; --3.21 => 4 rows

SELECT TOP 3 product_name, list_price 
FROM production.products 
ORDER BY list_price DESC; --3 rows

SELECT TOP 3 WITH TIES product_name, list_price 
FROM production.products 
ORDER BY list_price DESC; -- 6 rows
