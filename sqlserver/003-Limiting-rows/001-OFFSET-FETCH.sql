...
SELECT product_id, product_name, list_price FROM production.products ORDER BY list_price DESC, product_name;

-- Para omitir los primeros 10 productos (Desplazarce 10 registros) y devolver el resto, utilice la cláusula OFFSET como se muestra en la siguiente declaración:
SELECT product_id, product_name, list_price FROM production.products ORDER BY list_price DESC, product_name OFFSET 10 ROWS;

-- Para omitir los primeros 10 productos y seleccionar los siguientes 10 productos (Recuperar), utilice las cláusulas OFFSET y FETCH de la siguiente manera:
SELECT product_id, product_name, list_price FROM production.products ORDER BY list_price DESC, product_name OFFSET 10 ROWS FETCH NEXT 10 ROWS ONLY;
